...
export const INDIA_JOB_SOURCES: IndiaJobSource[] = [
  ...
  },
  {
    ...
    requiresBrowser: true,
    sourceType: 'portal',
    notes: 'YC-backed startups hiring portal. Extracts from __NEXT_DATA__ SSR payload with DOM fallback.',
  },
  {
    id: 'cutshort',
    label: 'Cutshort',
  ...
  },
  {
    ...
    requiresBrowser: true,
    sourceType: 'portal',
    notes: 'Tech-focused startup job board. Extracts from __NEXT_DATA__ SSR payload with DOM fallback.',
  },
  {
    id: 'instahyre',
    label: 'Instahyre',
  ...
  },
  {
    ...
    requiresBrowser: true,
    sourceType: 'portal',
    notes: 'Growth and marketing startup roles. Tries multiple URL variants with broad selector fallback.',
  },
  {
    id: 'otta',
    label: 'Otta',
    ...
    capabilities: {
      ...
      authGateRisk: 'high',
      directUrlVerification: 'often_403',
      fallbackSourceIds: ['wellfound', 'cutshort', 'company_ats'],
      liveProofStatus: 'partial',
      knownLimitations: ['Full job search often requires account sign-in; partial results may be returned for unauthenticated visitors.'],
    },
    notes: 'Global startup job board with India listings. Scrapes what is visible without auth; may return partial results.',
  },
  {
    id: 'wellfound',
    label: 'Wellfound',
